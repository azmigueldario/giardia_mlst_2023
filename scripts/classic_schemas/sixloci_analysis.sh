...
#SBATCH --job-name="sixloci_analysis"
...
mlst_fasta_dir="/project/60006/mdprieto/raw_data/giardia/MLST_loci/updated_six_loci"
results_dir="/scratch/mdprieto/results/giardia_classic_mlst/six_loci"
...
mkdir -p "${results_dir}/iqtree" &&
    apptainer exec ${iqtree_img} iqtree2 \
        -s ${results_dir}/multiple_alignment/merged_MSA.fasta \
        -m MFP \
        -B 1000 \
        -T AUTO \
        --alrt 1000  \
        --prefix "${results_dir}/iqtree/six_loci" \
        --verbose &&
    apptainer exec ${iqtree_img} iqtree2 \
        six_loci.treefile \
