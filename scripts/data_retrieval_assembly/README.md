...
2. `assembly_and_qc.sh`:  Runs bactopia/bactopia 3.0 pipeline for all accessions with short-read data. As _Giardia spp._ genome is mostly redundant across chromosomes, we can use bacterial sequencing assembly tools
